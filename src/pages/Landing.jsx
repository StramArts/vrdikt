...
function RoastCardPreview() {
  ...
  return (
    <div style={{
      ...
      position: 'relative',
      boxShadow: '0 0 0 1px rgba(255,85,0,0.08), 0 32px 64px rgba(0,0,0,0.6)',
    }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
        ...
        <div>
          <div style={{ color: '#FF5500', fontWeight: 700, fontSize: '12px', letterSpacing: '0.08em', textTransform: 'uppercase' }}>VRDIKT</div>
          <div style={{ color: 'rgba(255,255,255,0.38)', fontSize: '11px' }}>Financial Roast Report</div>
        </div>
        <div style={{ marginLeft: 'auto', display: 'flex', gap: '6px' }}>
          <div style={{ width: '9px', height: '9px', borderRadius: '50%', background: '#FF1040', opacity: 0.8 }} />
          <div style={{ width: '9px', height: '9px', borderRadius: '50%', background: '#FF5500', opacity: 0.6 }} />
          <div style={{ width: '9px', height: '9px', borderRadius: '50%', background: '#FFD000', opacity: 0.4 }} />
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{
          color: '#FF1040', fontSize: isMobile ? '13px' : '15px',
      ...
      <div style={{ display: 'flex', gap: '12px', marginTop: '16px' }}>
        {[
          { label: 'Dining', pct: 72, color: '#FF1040' },
          { label: 'Shopping', pct: 48, color: '#FF5500' },
          { label: 'Savings', pct: 8, color: '#FFD000' },
        ].map(({ label, pct, color }) => (
      ...
      <div style={{
        ...
        background: 'rgba(255,16,64,0.1)', border: '1px solid rgba(255,16,64,0.25)',
        borderRadius: '20px', padding: '3px 8px',
        fontSize: '10px', fontWeight: 700, color: '#FF1040', letterSpacing: '0.06em',
      }}>BRUTAL</div>
    </div>
  )
}
...
function StatPill({ value, label }) {
  return (
    <div style={{ textAlign: 'center', minWidth: '100px' }}>
      <div style={{ fontSize: '26px', fontWeight: 800, color: '#F0F0F0', letterSpacing: '-0.03em', fontFamily: 'var(--font-display, Outfit), sans-serif' }}>{value}</div>
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hovered ? 'rgba(255,85,0,0.2)' : 'rgba(255,255,255,0.07)'}`,
    ...
    >
      ...
      <h3 style={{ margin: 0, marginBottom: '8px', fontSize: '16px', fontWeight: 700, color: '#F0F0F0', fontFamily: 'var(--font-display, Outfit), sans-serif' }}>{title}</h3>
      <p style={{ margin: 0, fontSize: '14px', color: 'rgba(255,255,255,0.38)', lineHeight: '1.6' }}>{description}</p>
    </div>
  )
}
...
export default function Landing() {
  ...
  return (
    <div style={{ background: '#0A0A0A', minHeight: '100vh', fontFamily: 'var(--font-body, Outfit), sans-serif', color: '#F0F0F0' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          {!isMobile && (
            <button
              ...
              style={{
                ...
                cursor: 'pointer', transition: 'border-color 0.2s, color 0.2s', fontFamily: 'var(--font-ui, Space Grotesk), sans-serif',
              }}
          ...
          <button
            onClick={() => navigate('/auth')}
            style={{
              background: 'linear-gradient(135deg,#FF5500,#FF1040)', border: 'none',
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#FF5500', display: 'inline-block' }} />
          <span style={{ fontSize: isMobile ? '11px' : '13px', color: '#FF5500', fontWeight: 600, letterSpacing: '0.06em', fontFamily: 'var(--font-ui, Space Grotesk), sans-serif' }}>
        ...
        <p style={{
          ...
          color: 'rgba(255,255,255,0.38)', maxWidth: '540px', lineHeight: 1.65,
        ...
        <div style={{
          ...
          <button
            onClick={() => navigate('/auth')}
            style={{
              background: 'linear-gradient(135deg,#FF5500,#FF1040)', border: 'none', borderRadius: '14px',
              padding: isMobile ? '18px 24px' : '18px 40px',
              color: '#fff', fontSize: '17px', fontWeight: 800,
              cursor: 'pointer', letterSpacing: '-0.01em', fontFamily: 'var(--font-ui, Space Grotesk), sans-serif',
              transition: 'all 0.2s ease', boxShadow: '0 0 40px rgba(255,85,0,0.25)',
              WebkitTapHighlightColor: 'transparent',
              width: isMobile ? '100%' : 'auto',
            }}
            onMouseEnter={e => { e.currentTarget.style.opacity = '0.88'; e.currentTarget.style.boxShadow = '0 0 60px rgba(255,85,0,0.4)' }}
            onMouseLeave={e => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.boxShadow = '0 0 40px rgba(255,85,0,0.25)' }}
          >
            Get Roasted 🔥
          </button>
          <button
            ...
            style={{
              background: 'transparent', border: '1px solid rgba(255,255,255,0.14)', borderRadius: '14px',
              padding: isMobile ? '16px 24px' : '18px 32px',
              color: 'rgba(255,255,255,0.6)', fontSize: '17px', fontWeight: 600,
              cursor: 'pointer', fontFamily: 'var(--font-ui, Space Grotesk), sans-serif',
        ...
        <p style={{
          marginTop: '20px', fontSize: '12px', color: 'rgba(255,255,255,0.2)',
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: isMobile ? '40px' : '64px' }}>
          <p style={{ color: '#FF5500', fontSize: '12px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '14px', fontFamily: 'var(--font-ui, Space Grotesk), sans-serif' }}>
            Live preview
          </p>
          <h2 style={{ fontSize: isMobile ? '28px' : 'clamp(32px, 5vw, 52px)', fontWeight: 800, letterSpacing: '-0.03em', margin: 0, lineHeight: 1.1, fontFamily: 'var(--font-display, Outfit), sans-serif' }}>
            This is what brutal<br />
            <span style={{ color: '#FF1040' }}>honesty looks like.</span>
          </h2>
        </div>
            ...
            {[
              ...
              <div key={n} style={{ display: 'flex', gap: '16px' }}>
                <div style={{
                  ...
                  color: '#FF5500', fontSize: '12px', fontWeight: 800, flexShrink: 0,
                }}>{n}</div>
                <div>
                  <h3 style={{ margin: 0, marginBottom: '5px', fontSize: '15px', fontWeight: 700, color: '#F0F0F0', fontFamily: 'var(--font-display, Outfit), sans-serif' }}>{title}</h3>
                  <p style={{ margin: 0, fontSize: '14px', color: 'rgba(255,255,255,0.38)', lineHeight: 1.6 }}>{body}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ padding: isMobile ? '0 16px 80px' : '0 24px 120px', maxWidth: '1100px', margin: '0 auto', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: isMobile ? '40px' : '64px' }}>
          <h2 style={{ fontSize: isMobile ? '28px' : 'clamp(32px, 5vw, 52px)', fontWeight: 800, letterSpacing: '-0.03em', margin: 0, fontFamily: 'var(--font-display, Outfit), sans-serif' }}>
            Everything you need to<br />
            <span style={{ color: '#FF5500' }}>face your finances.</span>
          </h2>
        </div>
        <div style={{
          display: 'grid',
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: '#141414', border: '1px solid rgba(255,85,0,0.15)',
          borderRadius: '24px', padding: isMobile ? '40px 24px' : '64px 48px',
        }}>
          <div style={{ fontSize: '44px', marginBottom: '14px' }}>🔥</div>
          <h2 style={{ fontSize: isMobile ? '26px' : 'clamp(28px, 5vw, 44px)', fontWeight: 900, letterSpacing: '-0.03em', margin: 0, marginBottom: '14px', lineHeight: 1.1, fontFamily: 'var(--font-display, Outfit), sans-serif', color: '#F0F0F0' }}>
            Ready to hear the truth?
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.38)', fontSize: isMobile ? '15px' : '17px', marginBottom: '36px', lineHeight: 1.6 }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#fff', fontSize: isMobile ? '16px' : '18px', fontWeight: 800,
              cursor: 'pointer', letterSpacing: '-0.01em', fontFamily: 'var(--font-ui, Space Grotesk), sans-serif',
              transition: 'all 0.2s ease', boxShadow: '0 0 50px rgba(255,85,0,0.3)',
              display: 'block', margin: '0 auto', width: isMobile ? '100%' : 'auto',
              WebkitTapHighlightColor: 'transparent',
            }}
            onMouseEnter={e => { e.currentTarget.style.opacity = '0.88'; e.currentTarget.style.boxShadow = '0 0 70px rgba(255,85,0,0.5)' }}
            onMouseLeave={e => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.boxShadow = '0 0 50px rgba(255,85,0,0.3)' }}
          >
            Get Roasted — Free
          </button>
      ...
      <footer style={{
        ...
        <Logo size={18} />
        <p style={{ margin: 0, color: 'rgba(255,255,255,0.2)', fontSize: '13px' }}>
          © 2026 VRDIKT. Your money, our verdict.
        </p>
        <div style={{ display: 'flex', gap: '24px' }}>
          {['Privacy', 'Terms', 'Contact'].map(link => (
            <a key={link} href="#" style={{ color: 'rgba(255,255,255,0.2)', fontSize: '13px', textDecoration: 'none', transition: 'color 0.2s' }}
